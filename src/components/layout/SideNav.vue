<template>
  <v-col
    ...
    sm="4"
    cols="12"
    :class="mode === 'day' ? 'day' : 'night'"
  >
    <v-col id="profile">
      <div id="parent" lg="12" md="12" sm="12">
        <v-img :src="require('/src/assets/portpic1.jpg')" />
      </div>
      <span id="mds-mobile">
        <router-link :to="{ name: 'Home' }" id="link-mobile">
          >KAROLINA KOSINSKA >MULTIMEDIA DESIGN STUDENT
        </router-link>
      </span>
    </v-col>
    <v-col
  ...
  data() {
    return {
      works: [
        ...
        {
          name: "@VESTERHAVSGRUPPEN WEBSITE",
          src: "https://vesterhavsgruppen.netlify.app/",
        },
        {
          name: "@FANØ FLYER",
          src:
            "https://drive.google.com/file/d/1ci0IzsI_EWa0eNzthsxx4jcJjOlKrOmq/view?usp=sharing",
        },
      ],
